...
export function DiscordButton() {
  ...
  return (
    <Button
      onClick={login}
      disabled={loading}
      className="h-12 w-full cursor-pointer rounded-xl bg-[#5865F2] text-white transition-all duration-300 hover:bg-[#4752C4] hover:shadow-xl hover:shadow-indigo-500/30"
    >
      {loading ? (
